export default function DonateModal({ onClose }) {
  ...
  const shareApp = () => {
    const url  = 'https://interviewai.my.id'
...
const ov      = { position:'fixed', inset:0, background:'rgba(0,0,0,0.82)', backdropFilter:'blur(12px)', zIndex:300, display:'flex', alignItems:'center', justifyContent:'center', padding:20, animation:'fadeIn .2s ease' }
const modal   = { background:'#0f0f13', border:'1px solid rgba(255,255,255,0.08)', borderRadius:20, padding:'32px 26px 24px', width:'100%', maxWidth:360, position:'relative', animation:'fadeUp .25s ease' }
const xbtn    = { position:'absolute', top:14, right:14, background:'none', border:'none', color:'#555', cursor:'pointer', fontSize:15, padding:'2px 6px' }
const tag     = { fontFamily:'JetBrains Mono, monospace', fontSize:10, color:'#555', letterSpacing:'0.12em', textTransform:'uppercase', marginBottom:16 }
